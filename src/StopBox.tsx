...
class StopBox extends React.Component<IProps> {    
    render() {
        const stopField = this.props.stop ? <StopField stop={this.props.stop} handleResetClick={this.props.handleResetClick}/>: <SearchStopField handleNewSelectedStop={this.props.handleNewSelectedStop}/>
        return (
            <div>
