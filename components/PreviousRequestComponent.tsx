import { IFAIRTIQ_ANFRAGELISTE_ANTWORTLISTE } from 'pkm-tarifrechner/build/src/tarifrechner/fairtiq/interfaces';
import { Button } from 'react-bootstrap';


export interface PreviousRequestComponentProps {
    previousRequests: IFAIRTIQ_ANFRAGELISTE_ANTWORTLISTE[];
    handleResetPreviousCiCoRequests: () => void
}

export default function PreviousRequestComponent(props: PreviousRequestComponentProps) {
        ...
        <div className="col-sm-6">
            ...
            <div className="card shadow-sm rounded">
                ...
                <ul className="list-group list-group-flush">
                    ...
                    <li className="list-group-item" id="number_of_trips">{previousRequests.length} Fahrten vorhanden.</li>
                    <li className="list-group-item" id="reset_previous_trips_button">
                        <Button variant="secondary" onClick={handleResetPreviousCiCoRequests} disabled={previousRequests.length == 0}> Alle Fahrten zurücksetzen</Button>
                    </li>
                </ul>
