...
export default function RoutingComponent(props: RoutingComponentProps) {
    ...
    const handleResetClickForToStop = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        setToStop(null)
    }
    const handleResetClickForFromStop = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        setFromStop(null)
    }
    const handleResetClickForViaStop = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        setToStop(null)
    }
