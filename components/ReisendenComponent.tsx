  ...
  return (
    <Dropdown>
      <Dropdown.Toggle variant="secondary" id="dropdown-basic" size="sm">
        <UserPlusIcon /> weitere Reisende hinzufügen
      </Dropdown.Toggle>
              ...
              <li className="list-group-item" key={"reisender_li_" + index}>
                ...
                <span className="float-end">
                  ...
                  {istHauptnutzer && (
                    ...
                    >
                      {" "}
                      <TicketIcon />{props.berechtigungsliste.length !== 0 ? "Zeitkarte ändern" : "Zeitkarte hinterlegen"}
                    </button>
                  )}
                  <button
                    type="button"
